...
# Define your directory containing the count files (ReadsPerGene.out)
...
#########################################################################
#Create a MDS plot
samples=c(dds_set$condition)
print(samples)

dev_stage=c("T1","T1","T1","T2","T2","T2","T3","T3","T3")
#dev_stage=c("T1","T1","T1","T2","T2","T3","T3")
...
glimmaMDS(dds_set, group=metadata, col=c("#E97F89", "#6DA45F", "#E1CD86", "#E0A3D1"))
